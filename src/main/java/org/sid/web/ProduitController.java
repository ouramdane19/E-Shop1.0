...
import org.sid.CloudinaryConfig;
...
//	@RequestMapping(value = "/admin/save", method = RequestMethod.POST)
//	    public String processActor(@ModelAttribute Produit produit, 
...
//	        }
//	       
//	        String uploadResultUrl = cloudc.upload(file.getName());
//			produit.setPhoto(uploadResultUrl);
//			produitRepository.save(produit);
//	        return "redirect:/user/index";
//	    }
     // modifier un produit
